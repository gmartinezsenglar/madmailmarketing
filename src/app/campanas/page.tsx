          ...
          >
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <p className="text-gray-600 font-medium">Creada: {campana.fechaCreacion}</p>
              </div>
              <div className="flex gap-3">
                <Link href={`/campanas/${campana.id}/correos`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-xl text-center border-2 border-blue-200 shadow-md">
                <div className="text-3xl font-bold text-blue-600">{campana.correosEnviados}</div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-5 rounded-xl text-center border-2 border-green-200 shadow-md">
                <div className="text-3xl font-bold text-green-600">{campana.correosEntregados.toLocaleString()}</div>
                <div className="text-sm text-green-800 font-semibold mt-1">Correos Entregados</div>
              </div>
              <div className="bg-gradient-to-br from-sky-50 to-sky-100 p-5 rounded-xl text-center border-2 border-sky-200 shadow-md">
                <div className="text-3xl font-bold text-sky-600">{campana.totalCorreos}</div>
